...
class FieldRotationAndSampleTests(TestCase):
    ...
    def test_sample_endpoint_returns_formatted_rows(self):
        ...
        # Coluna crua da primeira linha (sem a transformação do campo) —
        # é o que a amostra ao vivo do nome do arquivo usa.
        self.assertEqual(payload["first_row_columns"], {"1": "joão da silva"})
